...
const MintCharacter = () => {
  ...
  const sendTxToBlockchain = async (metaData) => {
    try {
      setTxStatus("connecting to Optimism  Goerli Testnet Blockchain.");
      ...
      setErrorMessage("Failed to send tx to Optimism Goerli Testnet.");
      console.log(error);
    }
  };
  ...
  const previewNFT = (metaData, mintNFTTx) => {
    ...
    setTxURL(`https://goerli-optimism.etherscan.io/tx/${mintNFTTx.hash}`);
    ...
    <div className="bg-gray-100">
      ...
      <div className="flex justify-center">
        <div className="w-1/2 flex flex-col pb-12 ">
          ...
          />
          <input
            placeholder="Asset Price in OP Token"
            className="mt-5 border rounded p-4 text-xl"
